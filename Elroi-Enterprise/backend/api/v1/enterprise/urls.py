...
urlpatterns = [
    ...
    path('user-guide-upload',
         UserGuideUpload.as_view(),
         name="user_guide_upload"),
    path('customer-configuration',
         CustomerConfiguration.as_view(),
         name='customer_config_page'),
    path('customer-summarize/',
         CustomerSummarize.as_view(),
         name='customer_summarize'),
    ...
    path('get-extended-requests-report/',
         ExtendedVsNewRequests.as_view(),
         name='get_extended_requests_report'),
    path('consumer-request-config/',
